...
REG NO 24900571
 #include <WiFi.h>
 #include "ThingSpeak.h" // always include thingspeak header file after other header file
 #define ldr_pin 34
...
// your network key Index number (needed only for WEP)
 ...
 int ldrValue = 0;       
// Variable to store raw analog value
...
# CIRCUIT DIAGRAM:
![image](https://github.com/user-attachments/assets/0c2b0f95-0c76-4492-9e93-e8e97a0590ce)

# OUTPUT:
![image](https://github.com/user-attachments/assets/8d29ff8b-7bf4-4e56-b834-2911465e75a9)
